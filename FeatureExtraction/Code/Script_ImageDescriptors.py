...
__author__ = "Xim Cerda"
__license__ = "GPL"
__email__ = "xcerda@cvc.uab.es"
__year__ = "2025"
"""
### REFERENCES
...
from GaborFilters import GaborFilterBank2D,GaborFilterBank3D
from BrowseGaborFiltBank import BrowseGaborFiltBank
...
NiiPath=os.path.join(SessionDataFolder,ROIFolder,ROINiiFile)
NiiPath=NiiPath.replace('\\','/')
niiROI,_=readNifty(NiiPath)

NiiPath=os.path.join(SessionDataFolder,ROIFolder,MaskROINiiFile)
NiiPath=NiiPath.replace('\\','/')
